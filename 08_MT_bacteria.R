...
metadata_full <- read_xlsx("Papers/metadata_Root.xlsx")
...
# write.csv(Filtered_merged_degs_RO, "Filtered_merged_degs_RO_08_07.csv")
...
# Save the merged DEGs dataframe to a CSV
# write.csv(Filtered_merged_degs_OSPW, "Filtered_merged_degs_OSPW_08_07.csv")
...
# Save the merged DEGs dataframe to a CSV
# write.csv(Filtered_merged_degs, "Filtered_merged_degs_OSPWvsTime_08_07.csv")
...
# Save the merged DEGs dataframe to a CSV
# write.csv(Filtered_merged_degs, "Filtered_merged_degs_Water_type_OSPW_vs_RO_NoTimeIN_08_07.csv")
write.csv(Filtered_merged_degs, output_file, row.names = FALSE)
