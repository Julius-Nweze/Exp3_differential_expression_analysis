...
#SBATCH --time=00-05:00:00                 # Job time limit (DD-HH:MM)
#SBATCH --cpus-per-task=10                # Number of CPU cores (adjust as needed)
#SBATCH --job-name=Phospho-db        # Job name for easier identification
#SBATCH --output=Phospho-db-%j.out   # Standard output file
#SBATCH --error=Phospho-db-%j.err    # Standard error file
...
PHOS="/home/juli24/projects/def-yergeaue-ab/juli24/Exp3/Julius/PCyCDB/Phosphorus_cycling_database/PCyCDB.fasta"

# Output files and directories
OUTDIR="/home/juli24/projects/def-yergeaue-ab/juli24/Exp3/Julius/PCyCDB/Result"
OUTPUT_INDEX="/home/juli24/projects/def-yergeaue-ab/juli24/Exp3/Julius/blast_index/Contigs_renamed.faa"
OUTPUT="$OUTDIR/PCyCDB.output.txt"
OUTPUT2="$OUTDIR/PCyCDB.output2.txt"
OUTPUT_GENE="$OUTDIR/PCyCDB.phosphate_gene.faa"
...
blastp -query "$PHOS" -db "$OUTPUT_INDEX" -out "$OUTPUT" \
