...
sample_name=NS.LH00487_0019.005.NEBNext_i704---NEBNext_i507.M16E-624-Root-Exp3-D60
...
R1s=("/project/6004719/projects/GROW/MT_2024-10-06/bacteria/raw_reads/NS.LH00487_0019.005.NEBNext_i704---NEBNext_i507.M16E-624-Root-Exp3-D60_R1.fastq.gz")
R2s=("/project/6004719/projects/GROW/MT_2024-10-06/bacteria/raw_reads/NS.LH00487_0019.005.NEBNext_i704---NEBNext_i507.M16E-624-Root-Exp3-D60_R2.fastq.gz")
...
if [[ -f "${R1s[0]}" && -f "${R2s[0]}" ]]; then
    ...
    singularity run /home/juli24/scratch/singlem_0.18.3.sif pipe -1 "${R1s[0]}" -2 "${R2s[0]}" \
        -p "$OUT_profile/${sample_name}.profile.tsv" --otu-table "$OUT_otu/NS.LH00487_0019.005.NEBNext_i704---NEBNext_i507.M16E-624-Root-Exp3-D60.otu_table.tsv"
else
