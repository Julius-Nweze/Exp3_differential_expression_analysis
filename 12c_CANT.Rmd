...
# Save the CANT_abundance
# write.csv(long_data, "long_data_cpm.csv")

# Merge metadata and abundance
CANT_abundance <-  metadata %>% dplyr::left_join(long_data, by=c("Sample"), multiple = "all", relationship = "many-to-many")

# Save the CANT_abundance
write.csv(CANT_abundance, "CANT_abundance.csv")
...
CANT_abundance_tax <-  CANT_abundance %>% dplyr::left_join(Taxa, by=c("Gene_ID"), multiple = "all", relationship = "many-to-many")

# Save the CANT_abundance
write.csv(CANT_abundance_tax, "CANT_abundance_tax.csv")


# Load CANT_genes_converted
read_ods("CANT_converted.ods", sheet = "CANT",  col_names = TRUE) ->
CANT_gene

# Merge metadata, abundance and annotation
CANT_abundance_tax_blast <-  CANT_abundance_tax %>% dplyr::left_join(CANT_gene, by=c("Gene_ID"), multiple = "all", relationship = "many-to-many") %>% drop_na(Gene) %>% subset(tax_kingdom %in% c("Archaea", "Bacteria", "Algae", "Fungi"))

# Save the CANT_abundance
write.csv(CANT_abundance_tax, "CANT_abundance_tax_blast.csv")
...
Ab_NA <- CANT_abundance_tax_blast %>%
...
ggsave("Figures/Genes_CANT_OSPW_RO.svg", width = 65, height = 40, units = "cm")
...
ggsave("Figures/Taxa_origins_CANT_degraders_Phylum_OSPW_RO.svg", width = 45, height = 35, units = "cm")
...
ggsave("Figures/Taxa_origins_CANT_degraders_Order_OSPW_RO.svg", width = 45, height = 35, units = "cm")
